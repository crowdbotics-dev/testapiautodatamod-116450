...
## Project Structure
    ...
    ├── testapiautodatamod_116450  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116450`
...
2. Clone this repo and `cd testapiautodatamod_116450`
